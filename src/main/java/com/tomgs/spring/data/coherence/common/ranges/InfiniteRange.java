...
/**
 * An {@link InfiniteRange} represents the range of all possible long integer
 * values.
 * <p>
...
public class InfiniteRange implements Range, ExternalizableLite,
	...
	public Range remove(long value) {
		throw new UnsupportedOperationException(
				"Can't remove a value from an InfiniteRange");
	}
	...
	public Iterator<Long> iterator() {
		throw new UnsupportedOperationException(
				"Can't create an Iterator over an InfiniteRange");
	}

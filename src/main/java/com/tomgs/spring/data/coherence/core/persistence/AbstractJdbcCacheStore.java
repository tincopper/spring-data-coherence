...
package com.tomgs.spring.data.coherence.core.persistence;
...
public abstract class AbstractJdbcCacheStore<T>
    ...
    public Object load(Object key) {
        List<T> results = getJdbcCall().getJdbcTemplate().query(
    ...
    public void store(Object key, Object value) {
        getJdbcCall().getJdbcTemplate().update(getMergeSql(),
    ...
    public void storeBatch(Map mapBatch) {
    	...
    	Object[] obj=mapBatch.values().toArray();
    	List<Object[]> batchArgs= new ArrayList<Object[]>();
    	batchArgs.add(obj);
        getJdbcCall().getJdbcTemplate().batchUpdate(getMergeSql(),batchArgs);
    }

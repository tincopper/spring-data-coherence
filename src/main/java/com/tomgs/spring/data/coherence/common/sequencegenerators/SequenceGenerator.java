 ...
 * <p>
 * NOTE: All {@link SequenceGenerator} implementations <strong>must</strong> be
 * thread-safe. An individual {@link SequenceGenerator} must be capable of being
 * used by multiple-threads simultaneously without corrupting the underlying
 * sequence.
 * <p>
...
public interface SequenceGenerator {
	 ...
	 * from the sequence, the resulting {@link Range} being of length
	 * sequenceSize.
	 *
	 * @param sequenceSize
	 *            The number of values in the resulting {@link Range}.
	 *

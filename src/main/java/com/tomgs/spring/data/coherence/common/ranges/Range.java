...
/**
 * A {@link Range} represents an immutable sequence of increasing long integer
 * values.
 * <p>
...
public interface Range extends Iterable<Long> {
	...
	/**
	 * Returns if the {@link Range} is a singleton range. That is the number of
	 * values in the range is a single value, starting at 'x' and finishing at
	 * 'x'.
	 *
	 ...
	 *
	 * @param other
	 *            the other {@link Range}nge to check
	 *
	...
	/**
	 * Creates and returns a new {@link Range} representing the union of this
	 * and another {@link Range}.
	 *
	 * @param other
	 *            the other {@link Range}
	 *
	 * @return a new {@link Range} representing the union of this and another
	 *         {@link Range}
	 */
	public Range union(Range other);

	/**
	 * Creates and returns a new {@link Range} based on the current
	 * {@link Range} but with the specified value added.
	 *
	 * @param value
	 *            the value to add
	 *
	 * @return a new {@link Range} based on the current {@link Range} with the
	 *         specified value added
	 */
	public Range add(long value);

	/**
	 * Creates and returns a new {@link Range} based on this {@link Range} but
	 * with the specified value removed.
	 *
	 * @param value
	 *            the value to remove
	 *
	 * @return returns a new {@link Range} based on this {@link Range} with the
	 *         specified value removed
	 */
	public Range remove(long value);

	/**
	 * Returns an {@link Iterator} over the values in a {@link Range}, in order
	 * from lowest value to the highest value inclusive.
	 *

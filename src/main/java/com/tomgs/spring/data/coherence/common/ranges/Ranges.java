...
public final class Ranges {
	...
	/**
	 * A helper method to construct an empty {@link Range} commencing at a
	 * specified value.
	 *
	 * @param from
	...
	/**
	 * A helper method to construct a {@link Range} with only a single value.
	 *
	 * @param value
	 *            the value to have in the {@link Range}
	 *
	...
	/**
	 * A helper method to construct a {@link Range} between (and including) two
	 * values.
	 *
	 * @param from
	 *            the start of the {@link Range}
	 * @param to
	 *            the end of the {@link Range}
	 *
